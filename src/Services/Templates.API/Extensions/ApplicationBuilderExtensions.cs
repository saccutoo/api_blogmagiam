namespace API.Extensions
{
    ...
    public static partial class ApplicationBuilderExtensions
    {
        ...
        {
            var staticFolder = Path.Combine(Helpers.GetConfig("StaticFiles:Folder"));
            var staticFolderCheck = new DirectoryInfo(staticFolder);
            if (!staticFolderCheck.Exists)
            {
                staticFolderCheck.Create();
            }
            ...
            return application
                .UseStaticFiles(
                    ...
                    new StaticFileOptions()
                    {
                        ...
                        System.IO.Path.Combine(Helpers.GetConfig("StaticFiles:Folder"))),
